...
CREATE VIEW analytics.ceds_FactK12StudentEnrollment
AS
            ...
            AND (
                CASE 
                    WHEN StudentEnrollmentAcrossSchools.Count IS NOT NULL
                        ...
                        THEN 01810
                    WHEN CONVERT(CHAR(8), GETDATE(), 112) BETWEEN EntryDateKey
                            AND ExitWithdrawDateKey
                        THEN 01811
                    WHEN CONVERT(CHAR(8), GETDATE(), 112) <= ExitWithdrawDateKey
                        THEN 01812
