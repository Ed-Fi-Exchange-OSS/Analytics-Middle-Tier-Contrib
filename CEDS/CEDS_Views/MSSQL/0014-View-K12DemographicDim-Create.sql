...
ALTER VIEW analytics.ceds_K12DemographicDim
AS
...
SELECT '-1' AS K12DemographicDimId
    , '-1' AS K12DemographicKey
    , '' AS EconomicDisadvantageStatusCode
    , '' AS EconomicDisadvantageStatusDescription
    , '' AS EconomicDisadvantageStatusEdFactsCode
    , '' AS HomelessnessStatusCode
    , '' AS HomelessnessStatusDescription
    , '' AS HomelessnessStatusEdFactsCode
    , '' AS EnglishLearnerStatusCode
    , '' AS EnglishLearnerStatusDescription
    , '' AS EnglishLearnerStatusEdFactsCode
    , '' AS MigrantStatusCode
    , '' AS MigrantStatusDescription
    , '' AS MigrantStatusEdFactsCode
    , '' AS MilitaryConnectedStudentIndicatorCode
    , '' AS MilitaryConnectedStudentIndicatorDescription
    , '' AS MilitaryConnectedStudentIndicatorEdFactsCode
    , '' AS HomelessPrimaryNighttimeResidenceCode
    , '' AS HomelessPrimaryNighttimeResidenceDescription
    , '' AS HomelessPrimaryNighttimeResidenceEdFactsCode
    , '' AS HomelessUnaccompaniedYouthStatusCode
    , '' AS HomelessUnaccompaniedYouthStatusDescription
    , '' AS HomelessUnaccompaniedYouthStatusEdFactsCode
    , '' AS SexCode
    , '' AS SexDescription
    , '' AS SexEdFactsCode
...
SELECT ROW_NUMBER() OVER (
        ORDER BY K12DemographicKey
        ) AS K12DemographicDimId
    , K12DemographicKey
...
FROM (
    ...
    FROM (
        SELECT ReferenceEconomicDisadvantageStatusDescriptorm.CodeValue
        ...
        FROM MapReferenceDescriptor ReferenceEconomicDisadvantageStatusDescriptorm
        INNER JOIN edfi.StudentCharacteristicDescriptor AS EconomicDisadvantageStatusDescriptor
        ...
        WHERE ReferenceEconomicDisadvantageStatusDescriptorm.TableName = 'xref.EconomicDisadvantageStatus'
    ...
    CROSS JOIN (
        SELECT ReferenceHomelessnessStatusDescriptor.CodeValue
            ...
            , ReferenceHomelessnessStatusDescriptor.DescriptorId
        FROM MapReferenceDescriptor ReferenceHomelessnessStatusDescriptor
        INNER JOIN edfi.StudentCharacteristicDescriptor AS HomelessnessStatusDescriptor
            ON HomelessnessStatusDescriptor.StudentCharacteristicDescriptorId = ReferenceHomelessnessStatusDescriptor.DescriptorId
        WHERE ReferenceHomelessnessStatusDescriptor.TableName = 'xref.HomelessnessStatus'
    ...
    CROSS JOIN (
        SELECT ReferenceMigrantStatusDescriptor.CodeValue
            ...
            , ReferenceMigrantStatusDescriptor.DescriptorId
        FROM MapReferenceDescriptor ReferenceMigrantStatusDescriptor
        INNER JOIN edfi.Program
            ON ReferenceMigrantStatusDescriptor.CodeValue = Program.ProgramName
        WHERE ReferenceMigrantStatusDescriptor.TableName = 'xref.MigrantStatus'
    ...
    CROSS JOIN (
        SELECT ReferenceMilitaryConnectedStudentIndicatorDescriptor.CodeValue
            ...
            , ReferenceMilitaryConnectedStudentIndicatorDescriptor.DescriptorId
        FROM MapReferenceDescriptor ReferenceMilitaryConnectedStudentIndicatorDescriptor
        INNER JOIN edfi.StudentCharacteristicDescriptor AS MilitaryConnectedStudentIndicator
        ...
        WHERE ReferenceMilitaryConnectedStudentIndicatorDescriptor.TableName = 'xref.MilitaryConnectedStudentIndicator'
        ) AS ReferenceMilitaryConnectedStudentIndicatorDescriptor
    CROSS JOIN (
        SELECT ReferenceHomelessPrimaryNighttimeResidenceDescriptor.DescriptorId
        ...
        FROM MapReferenceDescriptor ReferenceHomelessPrimaryNighttimeResidenceDescriptor
        INNER JOIN edfi.StudentCharacteristicDescriptor AS HomelessPrimaryNighttimeResidence
        ...
        WHERE ReferenceHomelessPrimaryNighttimeResidenceDescriptor.TableName = 'xref.HomelessPrimaryNighttimeResidence'
        ) AS ReferenceHomelessPrimaryNighttimeResidenceDescriptor
    CROSS JOIN (
        SELECT ReferenceHomelessUnaccompaniedYouthStatusDescriptor.DescriptorId
        ...
        FROM MapReferenceDescriptor ReferenceHomelessUnaccompaniedYouthStatusDescriptor
        INNER JOIN edfi.StudentCharacteristicDescriptor AS HomelessUnaccompaniedYouthStatusCode
        ...
        WHERE ReferenceHomelessUnaccompaniedYouthStatusDescriptor.TableName = 'xref.HomelessUnaccompaniedYouthStatus'
    ...
    CROSS JOIN (
        SELECT ReferenceSexDescriptor.CodeValue
            ...
            , ReferenceSexDescriptor.DescriptorId
        FROM MapReferenceDescriptor ReferenceSexDescriptor
        LEFT JOIN edfi.Student
            ON BirthSexDescriptorId = ReferenceSexDescriptor.DescriptorId
        WHERE ReferenceSexDescriptor.TableName = 'xref.Sex'
