...
IF EXISTS analytics.ceds_K12SchoolDim;
    ...
    SELECT '-1' AS K12SchoolDimId
        ...
        , false AS CharterSchoolIndicator
    ...
    SELECT ROW_NUMBER() OVER (
        ...
        , CAST(School.SchoolId AS VARCHAR) AS K12SchoolKey
        , CAST(EducationOrganizationSchool.EducationOrganizationId AS VARCHAR) AS SchoolKey
