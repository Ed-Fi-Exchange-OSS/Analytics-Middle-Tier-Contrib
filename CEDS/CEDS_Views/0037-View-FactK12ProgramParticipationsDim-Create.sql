...
CREATE VIEW analytics.ceds_FactK12ProgramParticipation
AS
...
AS (
    ...
    INNER JOIN analytics.ceds_SchoolYearDim
        ON CONVERT(VARCHAR(8), StudentSpecialEducationProgramAssociation.BeginDate, 112) BETWEEN ceds_SchoolYearDim.SessionBeginDateKey
                AND ceds_SchoolYearDim.SessionEndDateKey
    INNER JOIN analytics.ceds_K12SchoolDim
        ON ceds_K12SchoolDim.SchoolIdentifierSea = StudentSpecialEducationProgramAssociation.EducationOrganizationId
