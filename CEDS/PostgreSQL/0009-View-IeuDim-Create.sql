...
IF EXISTS analytics.ceds_IeuDim;
    ...
    FROM (
        ...
        LEFT OUTER JOIN OrgEducationAddress AS MailingAddress
        ...
        LEFT OUTER JOIN OrgEducationAddress AS PhysicalAddress
