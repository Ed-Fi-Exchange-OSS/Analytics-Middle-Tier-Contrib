...
function Get-ErrorMessage($ErrorMessage) { $FinalErrorMessage = "Error occurred: $ErrorMessage" }

Export-ModuleMember Install-MSSQLODS, Install-PostgreSQLODS, Get-ErrorMessage